---
title: '@analogjs/vite-plugin-angular'
description: A Vite plugin for building Angular applications with support for TypeScript compilation and dev server integration.
---
