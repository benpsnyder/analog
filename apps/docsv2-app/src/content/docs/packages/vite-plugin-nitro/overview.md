---
title: '@analogjs/vite-plugin-nitro'
description: A lightweight Vite plugin for integrating with Nitro to enable SSR, pre-rendering, static site generation, and API routes.
---
