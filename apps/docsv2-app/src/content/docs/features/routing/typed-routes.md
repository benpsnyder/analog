---
title: Typed Routes (Experimental)
description: Analog supports experimental type-safe routing features that provide autocomplete, typed params, and typed query params across your entire application.
---
