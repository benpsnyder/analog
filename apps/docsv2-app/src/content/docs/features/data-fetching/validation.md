...
description: Analog supports runtime validation of server-side data using Standard Schema, a vendor-neutral interface implemented by Zod, Valibot, ArkType, and other schema libraries.
---
