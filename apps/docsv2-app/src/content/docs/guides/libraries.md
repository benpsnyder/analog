...
description: Angular libraries can be built using Vite and published to npm. This guide covers creating, configuring, building, and publishing an Angular library.
---
