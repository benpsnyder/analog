...
export const V18_X_ANALOG_JS_CONTENT = '^2.0.0-alpha.16.1';
export const V18_X_ANALOG_JS_ROUTER = '^2.0.0-alpha.16.1';
export const V18_X_ANALOG_JS_TRPC = '~0.3.0';
export const V18_X_ANALOG_JS_VITE_PLUGIN_ANGULAR = '^2.0.0-alpha.16.1';
export const V18_X_ANALOG_JS_VITEST_ANGULAR = '^2.0.0-alpha.16.1';
...
// devDependencies
export const V18_X_ANALOG_JS_PLATFORM = '^2.0.0-alpha.16.1';
